...
public class ELImgHtmlTag extends ImgHtmlTag {
    ...
    private void evaluateExpressions()
        ...
        if ((string =
                evalString("align", getAlignExpr())) != null) {
            setAlign(string);
        }

        if ((string =
                evalString("alt", getAltExpr())) != null) {
            setAlt(string);
        }

        if ((string =
                evalString("border", getBorderExpr())) != null) {
            setBorder(string);
        }

        if ((string =
                        evalString("dir", getDirExpr())) != null) {
                setDir(string);
        }

        if ((string =
                evalString("height", getHeightExpr())) != null) {
            setHeight(string);
        }

        if ((string =
                evalString("hspace", getHspaceExpr())) != null) {
            setHspace(string);
        }

        if ((string =
                evalString("ismap", getIsmapExpr())) != null) {
            setIsmap(string);
        }

        if ((string =
                evalString("lang", getLangExpr())) != null) {
                setLang(string);
        }

        if ((string =
                evalString("name", getNameExpr())) != null) {
            setName(string);
        }

        if ((string =
                evalString("onclick", getOnclickExpr())) != null) {
            setOnclick(string);
        }

        if ((string =
                evalString("ondblclick", getOndblclickExpr())) != null) {
            setOndblclick(string);
        }

        if ((string =
                evalString("onkeydown", getOnkeydownExpr())) != null) {
            setOnkeydown(string);
        }

        if ((string =
                evalString("onkeypress", getOnkeypressExpr())) != null) {
            setOnkeypress(string);
        }

        if ((string =
                evalString("onkeyup", getOnkeyupExpr())) != null) {
            setOnkeyup(string);
        }

        if ((string =
                evalString("onmousedown", getOnmousedownExpr())) != null) {
            setOnmousedown(string);
        }

        if ((string =
                evalString("onmousemove", getOnmousemoveExpr())) != null) {
            setOnmousemove(string);
        }

        if ((string =
                evalString("onmouseout", getOnmouseoutExpr())) != null) {
            setOnmouseout(string);
        }

        if ((string =
                evalString("onmouseover", getOnmouseoverExpr())) != null) {
            setOnmouseover(string);
        }

        if ((string =
                evalString("onmouseup", getOnmouseupExpr())) != null) {
            setOnmouseup(string);
        }

        if ((string =
                evalString("src", getSrcExpr())) != null) {
            setSrc(string);
        }

        if ((string =
                evalString("style", getStyleExpr())) != null) {
            setStyle(string);
        }

        if ((string =
                evalString("styleClass", getStyleClassExpr())) != null) {
            setStyleClass(string);
        }

        if ((string =
                evalString("styleId", getStyleIdExpr())) != null) {
            setStyleId(string);
        }

        if ((string =
                evalString("title", getTitleExpr())) != null) {
            setTitle(string);
        }


        if ((string =
                evalString("usemap", getUsemapExpr())) != null) {
            setUsemap(string);
        }

        if ((string =
                evalString("vspace", getVspaceExpr())) != null) {
            setVspace(string);
        }

        if ((string =
                evalString("width", getWidthExpr())) != null) {
            setWidth(string);
        }
    }

    /**
     * Evaluate the EL expression passed as parameter
     * @param propertyName the property name
     * @param propertyValue the property value
     * @return the value corresponding to the EL expression passed as parameter
     * @throws JspException
     */
    private String evalString(String propertyName, String propertyValue) throws JspException{
    	
    	return (String) ExpressionEvaluatorManager.evaluate("srcExpr",
