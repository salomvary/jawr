 ...
 */
public abstract class AbstractChainedProcessor<T> implements
		ChainedProcessor<T> {
	...
	/** The next processor */
	private ChainedProcessor<T> nextProcessor;
	
	/**
	 * Constructor
	 * @param id the ID of the processor
	 */
	public AbstractChainedProcessor(String id) {
		this.id = id;
	}
	...
	public void addNextProcessor(
			ChainedProcessor<T> nextProcessor) {
