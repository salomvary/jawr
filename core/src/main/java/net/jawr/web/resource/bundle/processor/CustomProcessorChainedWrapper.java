 ...
 *
 */
public class CustomProcessorChainedWrapper<T> extends AbstractChainedProcessor<T> {
	 ...
	 */
	public CustomProcessorChainedWrapper(String id, GlobalProcessor<T> globalPreprocessor) {
		super(id);
