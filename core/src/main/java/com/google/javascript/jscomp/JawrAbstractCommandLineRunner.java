 ...
 */
abstract class JawrAbstractCommandLineRunner<A extends Compiler,
  ...
  JawrAbstractCommandLineRunner() {
    this(System.out, System.err);
  }

  JawrAbstractCommandLineRunner(PrintStream out, PrintStream err) {
  ...
  final public void run() {
    ...
    } catch (JawrAbstractCommandLineRunner.FlagUsageException e) {
   ...
   */
  protected List<JSModule> createJsModules(
 ...
 * @param modulesByName the map of JS module declared
